...
TAXONOMY = [
    ...
    folder("body", "体型部位", "◒", "#e789b3", "体型、胸腹、四肢、器官与身体结构", [
        ...
        category("feet_toes", "足部脚趾"), category("internal_organs", "骨骼内脏"),
    ...
    folder("culture_objects", "文化用品", "▤", "#c99562", "书报纸张、文具画具、乐器与礼仪用品", [
        category("books_paper", "书报纸张"), category("stationery", "文具画具"),
        category("music", "音乐乐器"), category("ritual_object", "礼仪用品"),
    ]),
    folder("household_objects", "生活用品", "▣", "#c49d73", "家具、灯具、家电、工具、材料、容器与药剂液体", [
...
V20_EXACT_LOCATIONS = {
    ...
    "on_floor": ("pose", "object_pose"),
    "mini_hat": ("head_accessories", "themed_hair_ornament"),
    "on_chair": ("pose", "object_pose"),
    "glint": ("light_effect", "optical"),
    "leash": ("sensitive", "restraint"),
    "forehead_mark": ("face", "face_mark"),
    "aged_up": ("themes", "identity_change"),
    "rock": ("nature", "mineral"),
    "naughty_face": ("expression", "positive"),
    "breasts_squeezed_together": ("body", "breast_chest"),
    "object_insertion": ("adult_kink", "adult_insertion"),
    "ice": ("nature", "water_ice"),
    "large_areolae": ("adult_body", "nipples"),
    "card_(medium)": ("style", "medium"),
    "long_fingernails": ("body_detail", "nail_care"),
    "zoom_layer": ("composition", "layout"),
    "hat_flower": ("accessories", "badges_ornaments"),
    "water_drop": ("nature", "water_ice"),
    "sand": ("nature", "mineral"),
    "sharp_fingernails": ("body_detail", "nail_care"),
    "on_ground": ("pose", "object_pose"),
    "criss-cross_halter": ("clothing_detail", "strap_detail"),
    "sitting_on_person": ("action", "interaction"),
    "jacket_on_shoulders": ("clothing_appearance", "wearing_state"),
    "alternate_color": ("themes", "persona_variant"),
    "bandana": ("head_accessories", "headwrap_veil"),
    "ofuda": ("symbols", "religious_symbol"),
    "on_couch": ("pose", "object_pose"),
    "white_capelet": ("outerwear_suits", "cape_cloak"),
    "gag": ("sensitive", "restraint"),
    "gagged": ("sensitive", "restraint"),
    "licking_lips": ("face", "oral_detail"),
    "abyssal_ship": ("creatures", "fantasy_creature"),
    "angel": ("people", "fantasy_person"),
    "shota": ("adult_kink", "adult_taboo"),
    "dakimakura_(medium)": ("style", "medium"),
    "bloomers": ("underwear_swim", "panties_underwear"),
    "covering_breasts": ("action", "body_cover"),
    "tress_ribbon": ("head_accessories", "hairband_ribbon"),
    "underbust": ("underwear_swim", "bra_lingerie"),
    "w": ("pose", "hand_gesture"),
    "ahegao": ("adult", "adult_response"),
    "claw_pose": ("pose", "hand_gesture"),
    "joints": ("body", "internal_organs"),
    "+++": ("expression", "dramatic_effect"),
    "winter_clothes": ("clothing_appearance", "fashion_style"),
    "on_head": ("action", "interaction"),
    "glass": ("household_objects", "material"),
    "retro_artstyle": ("style", "era_style"),
    "armored_boots": ("protective_clothes", "leg_armor"),
    "bun_cover": ("head_accessories", "hairtie_ring"),
    "cheerleader": ("people", "occupation"),
    "open_hand": ("pose", "hand_gesture"),
    "road": ("outdoor_scene", "terrain_surface"),
    "arm_strap": ("accessories", "badges_ornaments"),
    "miko": ("people", "occupation"),
    "squiggle": ("expression", "dramatic_effect"),
    "fairy": ("people", "fantasy_person"),
    "nipple_slip": ("adult_body", "adult_clothes"),
