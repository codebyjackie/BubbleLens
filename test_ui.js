...
(async () => {
  ...
  const dragOrder = await page.evaluate(() => {
    ...
    return JSON.parse(localStorage.getItem('prompt-atelier-library-v1')).order;
  });
  ...
  const editedData = await page.evaluate(() => JSON.parse(localStorage.getItem('prompt-atelier-library-v1')));
  ...
  const copiedData = await page.evaluate(() => JSON.parse(localStorage.getItem('prompt-atelier-library-v1')));
  ...
  const migrated = await page.evaluate(() => JSON.parse(localStorage.getItem('prompt-atelier-library-v1')));
  ...
  const restored = await page.evaluate(() => JSON.parse(localStorage.getItem('prompt-atelier-library-v1')));
  ...
  assert.strictEqual(await page.evaluate(() => localStorage.getItem('prompt-atelier-ui-scale')), '140');
