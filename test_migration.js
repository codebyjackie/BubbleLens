...
assert.strictEqual(migrated.baseCatalogVersion, 18);
...
assert.strictEqual(migratedV8.baseCatalogVersion, 18);
...
assert.strictEqual(migratedV9.baseCatalogVersion, 18);
...
assert.strictEqual(migratedV10.baseCatalogVersion, 18);
...
assert.strictEqual(migratedV11.baseCatalogVersion, 18);
...
assert.strictEqual(migratedV12.baseCatalogVersion, 18);
...
assert.strictEqual(migratedV13.baseCatalogVersion, 18);
...
assert.strictEqual(migratedV14.baseCatalogVersion, 18);
assert.deepStrictEqual(api.normalizeLibraryEdits(migratedV14, catalog), migratedV14);

console.log('v6/v7/v8/v9/v10/v11/v12/v13/v14/v15/v16/v17 -> v18 library migration: ok');
